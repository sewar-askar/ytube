...
export const analyzeCommentsWithGemini = async (comments, language) => {
  try {
    const prompt = `Analyze and summarize the following YouTube comments, focusing on factual feedback. Exclude irrelevant or off-topic comments. Provide detailed summaries in ${language}, structured in markdown format as follows:
